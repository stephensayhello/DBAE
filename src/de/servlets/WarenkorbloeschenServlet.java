...
/**
 * Servlet implementation class WarenkorbloeschenServlet
 */
@WebServlet("/WarenkorbloeschenServlet")
public class WarenkorbloeschenServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WarenkorbloeschenServlet() {
        super();
